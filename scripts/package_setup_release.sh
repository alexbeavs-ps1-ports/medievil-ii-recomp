...
#
# Writes: dist/medievil-ii-recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix medievil-ii-recomp \
  --exe-name MediEvil_II__Recompiled \
  --display-name "MediEvil II  Recompiled" \
